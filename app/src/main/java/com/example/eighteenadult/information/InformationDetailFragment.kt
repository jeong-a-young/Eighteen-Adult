 ...
 * Use the [InformationDetailFragment.newInstance] factory method to
...
class InformationDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InformationDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InformationDetailFragment().apply {
